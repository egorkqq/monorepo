...
export const ArrowCircleUp2Icon: React.FC<SvgProps> = ({ className }) => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="none" className={className}>
    ...
    />
    <path stroke="inherit" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 11.5l3-3 3 3" />
  </Svg>
);
